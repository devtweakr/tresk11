...
var routes = [{
  ...
  path: '/najboljsi-videospot',
  component: NajboljsiVideospot
}, {
  path: '/najboljsa-fotografija',
  component: NajboljsaFotografija
}, {
  path: '/najboljsi-plakat',
  component: NajboljsiPlakat
}, {
  path: '/najboljsa-podoba',
  component: NajboljsaPodoba
}, {
  path: '/najbolj-inovativen',
  component: NajboljInovativen
}];
